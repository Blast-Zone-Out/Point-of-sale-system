...
Partial Public Class InventoryDataSet
    ...
    Partial Public Class InventoryDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddInventoryRow(ByVal Item As String, ByVal Quantity As Integer) As InventoryRow
            Dim rowInventoryRow As InventoryRow = CType(Me.NewRow,InventoryRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Item, Quantity}
...
Namespace InventoryDataSetTableAdapters
    ...
    Partial Public Class InventoryTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Inventory` WHERE ((`ItemID` = ?) AND ((? = 1 AND `Item` IS NULL) OR "& _ 
                "(`Item` = ?)) AND ((? = 1 AND `Quantity` IS NULL) OR (`Quantity` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Inventory` (`Item`, `Quantity`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Inventory` SET `Item` = ?, `Quantity` = ? WHERE ((`ItemID` = ?) AND ((? ="& _ 
                " 1 AND `Item` IS NULL) OR (`Item` = ?)) AND ((? = 1 AND `Quantity` IS NULL) OR ("& _ 
                "`Quantity` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.POS.My.MySettings.Default.InventoryConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ItemID, Item, Quantity FROM Inventory"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT ItemID, Item, Quantity FROM Inventory WHERE Item = ?"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Item", Global.System.Data.OleDb.OleDbType.WChar, 255, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Item", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(2) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT ItemID, Item, Quantity FROM Inventory WHERE Quantity = ?"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As InventoryDataSet.InventoryDataTable, ByVal Item As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy1(ByVal dataTable As InventoryDataSet.InventoryDataTable, ByVal Quantity As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (Quantity.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Quantity.Value,Integer)
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
            If (Me.ClearBeforeFill = true) Then
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ItemID As Integer, ByVal Original_Item As String, ByVal Original_Quantity As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Item As String, ByVal Quantity As Global.System.Nullable(Of Integer)) As Integer
            If (Item Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal Item As String, ByVal Quantity As Global.System.Nullable(Of Integer), ByVal Original_ItemID As Integer, ByVal Original_Item As String, ByVal Original_Quantity As Global.System.Nullable(Of Integer)) As Integer
            If (Item Is Nothing) Then
